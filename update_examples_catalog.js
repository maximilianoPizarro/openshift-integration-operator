...
if (match) {
  const newExamples = `
      ...
      { num: "303", name: "teams-channel-post", comp: "https, log", desc: "Post to Microsoft Teams incoming webhook (Secrets: TEAMS_WEBHOOK_URL)" },
      { num: "304", name: "whatsapp-send-message", comp: "https, log", desc: "Send WhatsApp Business API message (Secrets: WHATSAPP_ACCESS_TOKEN, WHATSAPP_PHONE_NUMBER_ID)" },
      { num: "305", name: "instagram-graph-post", comp: "https, log", desc: "Publish via Instagram Graph API (Secrets: INSTAGRAM_ACCESS_TOKEN, INSTAGRAM_BUSINESS_ACCOUNT_ID)" },
      { num: "306", name: "linkedin-share-post", comp: "https, log", desc: "Share update via LinkedIn API (Secrets: LINKEDIN_ACCESS_TOKEN)" },`;
